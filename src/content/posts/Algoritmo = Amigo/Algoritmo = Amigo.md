...
Hoy vivimos con un acompañante invisible.
Un sistema que conoce nuestros gustos, predice nuestras decisiones y elige por nosotros incluso antes de que sepamos qué queremos.

No tiene rostro, pero influye en los rostros que vemos.
No tiene voz, pero define las conversaciones que llegan a nuestros oídos.
No es humano, pero moldea nuestras relaciones como si lo fuera.

Este documental nace de una idea simple y poderosa:
si el algoritmo es nuestro amigo… ¿cuánto de nuestra vida le hemos entregado?

A través de imágenes intensas, pistas visuales, carpetas de investigación, pantallas en silencio y esa estética inquietante que solo lo digital puede tener, descubrimos algo claro:
los algoritmos no son malignos…
pero tampoco neutrales.

Son espejos.
Amplificadores.
Atajos que poco a poco pueden convertirse en caminos de una sola dirección.

Algoritmo = Amigo es una invitación a detenerse un segundo y recuperar la pregunta más humana de todas:
¿Qué quiero yo?
No: ¿qué quiere el algoritmo que yo quiera?

Tú aún tienes la elección.
La pregunta es si estás listo para usarla.
...
src="https://youtu.be/nDZ3gBdjda4" 
